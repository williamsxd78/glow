...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-30 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_8px_30px_rgba(37,211,102,0.5)] hover:scale-105 transition-transform"
